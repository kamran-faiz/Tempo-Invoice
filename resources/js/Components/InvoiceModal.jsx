...
export default function InvoiceModal() {
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 md:p-8">
            ...
            {/* Modal Card */}
            <div className="relative w-full max-w-5xl bg-surface-container-lowest rounded-xl border border-outline-variant shadow-2xl overflow-hidden flex flex-col max-h-[921px]">
                
                {/* Modal Header */}
                <div className="px-8 py-5 border-b border-outline-variant flex justify-between items-center bg-surface-bright">
                    <h2 className="font-headline-lg text-headline-lg font-bold text-on-surface">Create Invoice</h2>
                        ...
                        <section className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="col-span-full md:col-span-1">
                                ...
                                <div className="relative">
                                    <input className="w-full bg-white border border-outline-variant rounded-lg px-4 py-3 font-body-md focus:ring-2 focus:ring-primary focus:border-primary outline-none transition-all" placeholder="Search client..." type="text"/>
                            ...
                            <div className="md:col-span-1">
                                ...
                                <input className="w-full bg-surface-container border border-outline-variant rounded-lg px-4 py-3 font-body-md text-on-surface-variant cursor-not-allowed outline-none" readOnly type="text" value="INV-408"/>
                            </div>
                            <div>
                                <label className="block font-label-md text-label-md text-on-surface-variant mb-2">Invoice Date</label>
                                <input className="w-full bg-white border border-outline-variant rounded-lg px-4 py-3 font-body-md focus:ring-2 focus:ring-primary outline-none" type="date" defaultValue="2026-05-15"/>
                            </div>
                            <div>
                                <label className="block font-label-md text-label-md text-on-surface-variant mb-2">Due Date</label>
                                <input className="w-full bg-white border border-outline-variant rounded-lg px-4 py-3 font-body-md focus:ring-2 focus:ring-primary outline-none" type="date" defaultValue="2026-05-30"/>
                            </div>
                        </section>
                            ...
                            <div className="overflow-x-auto">
                                <table className="w-full text-left">
                                    ...
                                    <tbody className="divide-y divide-outline-variant">
                                        ...
                                        <tr className="group">
                                            <td className="py-4 pr-4">
                                                <select className="w-full bg-white border border-outline-variant rounded-lg px-3 py-2 font-body-md outline-none" defaultValue="Security Audit">
                                                    <option>Security Audit</option>
                                                    <option>Cloud Infrastructure</option>
                                                </select>
                                            </td>
                                            <td className="py-4 px-4">
                                                <input className="w-full bg-white border border-outline-variant rounded-lg px-3 py-2 font-body-md outline-none" type="text" defaultValue="Quarterly compliance review"/>
                                            </td>
                                            <td className="py-4 px-4">
                                                <input className="w-full bg-white border border-outline-variant rounded-lg px-3 py-2 font-body-md outline-none" type="number" defaultValue="1"/>
                                            </td>
                                            <td className="py-4 px-4">
                                                <input className="w-full bg-white border border-outline-variant rounded-lg px-3 py-2 font-body-md outline-none" type="number" defaultValue="25000"/>
                                            </td>
                                            <td className="py-4 px-4">
                                                <input className="w-full bg-white border border-outline-variant rounded-lg px-3 py-2 font-body-md outline-none" type="number" defaultValue="18"/>
                                            </td>
                                            <td className="py-4 pl-4 text-right font-body-md">29,500</td>
                                            <td className="py-4 pl-4 text-center">
                                                <button type="button" className="text-outline hover:text-error transition-colors">
                                                    <span className="material-symbols-outlined text-lg">delete</span>
                                                </button>
                        ...
                        <div className="bg-white border border-outline-variant rounded-xl p-6 space-y-4">
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="font-body-md font-medium">Not Submitted</span>
                                </div>
                            </div>
                            <div className="space-y-2">
                                <p class="font-label-sm text-label-sm text-on-surface-variant uppercase tracking-wider">IRN Number</p>
                                <p className="font-body-md text-on-surface-variant italic">Will be generated on save</p>
                            </div>
                        ...
                        <div className="bg-surface-variant/30 rounded-xl p-6 space-y-4 border border-outline-variant/50">
                            ...
                            <div className="space-y-3">
                                <div className="flex justify-between items-center">
                                    <span class="font-label-sm text-label-sm text-on-surface-variant">Created By</span>
                ...
                <div className="px-8 py-6 border-t border-outline-variant bg-surface-bright flex flex-col md:flex-row justify-end gap-4">
                    <button type="button" className="px-6 py-2.5 border border-outline text-on-surface-variant font-label-md text-label-md rounded-lg hover:bg-surface-container transition-colors">
                        Cancel
                    </button>
