                        ...
                        <section className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="col-span-full md:col-span-1">
                                ...
                                <div className="relative">
                                    ...
                                    onChange={e => form.setData('client_id' , e.target.value)} className="w-full bg-white border border-outline-variant rounded-lg px-4 py-3 font-body-md focus:ring-2 focus:ring-primary focus:border-primary outline-none transition-all" placeholder="Search client..." type="text"/>
                            ...
                            <div>
                                ...
                                onChange={e => form.setData ('issue_date', e.target.value)} className="w-full bg-white border border-outline-variant rounded-lg px-4 py-3 font-body-md focus:ring-2 focus:ring-primary outline-none" type="date" defaultValue="2026-05-15"/>
                            </div>
                            <div>
                                <label className="block font-label-md text-label-md text-on-surface-variant mb-2">Due Date</label>
                                <input
                                value={form.data.due_date}
                                onChange={e => form.setData ('due_date', e.target.value)} className="w-full bg-white border border-outline-variant rounded-lg px-4 py-3 font-body-md focus:ring-2 focus:ring-primary outline-none" type="date" defaultValue="2026-05-30"/>
                            </div>
                        </section>
