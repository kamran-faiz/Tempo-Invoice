...
<button onClick={() => setActiveModal('client')} className="w-full py-3 px-4 border border-outline-variant text-on-surface rounded-lg font-label-md text-label-md flex items-center justify-center gap-2 hover:bg-surface-container-high transition-all">
...
<ClientModal show={activeModal === 'client'} client={null} onClose={() => setActiveModal(null)} />
        </AuthenticatedLayout>
    )
}
