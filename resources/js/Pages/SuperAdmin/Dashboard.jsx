                    ...
                    <div className="glass-panel p-lg rounded-xl lg:col-span-2">
                        ...
                        <div className="space-y-4">
                            <div className="flex items-start gap-4 pb-4 border-b border-outline-variant/30">
                                ...
                                <div className="flex-1">
                                    <p className="font-body-md text-body-md text-on-surface">
                                        <span className="font-bold text-primary-fixed-dim">Indus Tech</span> generated a new invoice for PKR 45,000.
                                    </p>
                            ...
                            <div className="flex items-start gap-4 pb-4 border-b border-outline-variant/30">
                                ...
                                <div className="flex-1">
                                    <p className="font-body-md text-body-md text-on-surface">
                                        <span className="font-bold text-primary-fixed-dim">Habib Architects</span> added 3 new clients to their profile.
                                    </p>
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div className="flex-1">
                                    <p className="font-body-md text-body-md text-on-surface">
                                        <span className="font-bold text-primary-fixed-dim">Peak Performance</span> failed subscription payment (Auto-suspended).
                                    </p>
